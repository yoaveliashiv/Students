    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (flagConnected) {
                    Intent intent = new Intent(MainActivity1.this, MainActivityPageUser.class);
                    startActivity(intent);

                } else {
                    Intent intent = new Intent(MainActivity1.this, MainActivityRegister.class);
                    startActivity(intent);
                }
            }
        });
        ...
        feedbekButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (firebaseUser != null) {
                    ...
                    Toast.makeText(MainActivity1.this, "אנא התחבר או הירשם", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(MainActivity1.this, MainActivity_Feedback.class);
        ...
        cardRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (arrayListCards2.size() > 0) {
                    ...
                    toyAdapter1 = new CardCarAdapter(MainActivity1.this, 0, 0, arrayListCards2, false, 2);
                    ...
                    lv11.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            Intent intent = new Intent(MainActivity1.this, MainActivityCardView.class);
        ...
        cardRef2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (arrayListCards.size() > 0) {
                    ...
                    cardCarAdapter = new CardCarAdapter(MainActivity1.this, 0, 0, arrayListCards, false, 2);
                    //phase 4 reference to listview
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(MainActivity1.this, "הכניסה הצליחה", Toast.LENGTH_SHORT).show();
                            loginButtonMain.setText("יציאה");
                            progressDialog.dismiss();
                            Intent intent = new Intent(MainActivity1.this, MainActivityPageUser.class);
                            startActivity(intent);
...
//                                textViewWarnAll.setVisibility(View.VISIBLE);
                            ...
                            editTextPassword.requestFocus();
                            Toast.makeText(MainActivity1.this, "הכניסה נכשלה", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void sendVerificationCode(String mobile) {
        PhoneAuthOptions options = PhoneAuthOptions.newBuilder(mAuth)
                ...
                .setActivity(MainActivity1.this)
...
//        buttonData.setTextSize(8);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.mainMenu:
                intent2 = new Intent(MainActivity1.this, MainActivity1.class);
            ...
            case R.id.myPageMenu:
                intent2 = new Intent(MainActivity1.this, MainActivityPageUser.class);
                startActivity(intent2);
                return true;
            case R.id.cardCarMenu:
                intent2 = new Intent(MainActivity1.this, MainActivityRegisterTutor.class);
                startActivity(intent2);
                return true;
            default:
