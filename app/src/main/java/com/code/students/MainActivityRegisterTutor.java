...
public class MainActivityRegisterTutor extends AppCompatActivity {
    ...
    private CardTutor cardTutor = new CardTutor();
    ...
    private CardTutor cardTutorEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (flagManagementCardsApprov) {
            ...
            if (cardTutorEdit.getPermissionToPublish() == 0) {
                buttonRegister.setText("אישור");
                buttonDelete.setText("סירוב");
                buttonDelete.setVisibility(View.VISIBLE);
            } else {
                email = cardTutorEdit.getEmail();
            ...
            imageView1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (flagEdit && flagImageDeleteConfirmation != 1) {
                        ...
                        //           removeImage = cardTutorEdit.getImageViewArrayListName().get(0);
                    }
...
//        Long today = MaterialDatePicker.todayInUtcMilliseconds();
        ...
        buttonMyPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MainActivityRegisterTutor.this, MainActivityPageUser.class);
                startActivity(intent);

            }
        });
        Button button = findViewById(R.id.buttonExpertise);
    ...
    private void cardsApprov() {
        cardTutorEdit.setPermissionToPublish(1);
        ...
        ref2.child(cardTutorEdit.getKey()).removeValue();
        cardTutorEdit.setKey(keyApprov);
        ref.setValue(cardTutorEdit);

        DatabaseReference ref3 = FirebaseDatabase.getInstance().getReference("RegisterInformation");
        ref3.orderByChild("email").equalTo(cardTutorEdit.getEmail()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                // Toast.makeText(MainActivityRegisterTutor.this, snapshot.toString(), Toast.LENGTH_LONG).show();
                ...
                List<CardTutor> cardTutorList = registerInformation.getCardsUser();
                for (int j = 0; j < cardTutorList.size(); j++) {
                    if (cardTutorList.get(j).getId() == cardTutorEdit.getId()) {
    ...
    private void cardsRejection() {
        cardTutorEdit.setRejection(editTextRemarks.getText().toString());
        cardTutorEdit.setPermissionToPublish(2);
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("CardsRejection").push();
        final String keyRejection = ref.getKey();
        DatabaseReference ref2 = FirebaseDatabase.getInstance().getReference("CardsWaitApprov");
        ref2.child(cardTutorEdit.getKey()).removeValue();
        cardTutorEdit.setKey(keyRejection);
        ref.setValue(cardTutorEdit);


        DatabaseReference cardRef2 = FirebaseDatabase.getInstance().getReference("RegisterInformation");

        cardRef2.orderByChild("email").equalTo(cardTutorEdit.getEmail()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                // Toast.makeText(MainActivityRegisterTutor.this, snapshot.toString(), Toast.LENGTH_LONG).show();
    ...
    private void setTextCard() {
        List<String> urlImage = cardTutorEdit.getImageViewArrayListName();
        cardTutor.setImageViewArrayListName(urlImage);
        ...
        editTextCity.setText(cardTutorEdit.getCity());
        editTextName.setText(cardTutorEdit.getName());

        editTextPriceForDay.setText(cardTutorEdit.getPriceToLesson());
        editTextPhone.setText(cardTutorEdit.getPhone());

        cardTutor.setArrayListExpertise(cardTutorEdit.getArrayListExpertise());
        ListView lv1 = findViewById(R.id.listViewMainAddexp);
        ExpertiseAdapter expertiseAdapter = new ExpertiseAdapter(MainActivityRegisterTutor.this, 0, 0, cardTutorEdit.getArrayListExpertise());
        ...
        editTextRemarks.setText(cardTutorEdit.getRemarks());
        if (cardTutorEdit.getPermissionToPublish() == 2 && cardTutorEdit.getRejection().length() > 0) {
            editTextRemarks.setText("סורב מפני: " + cardTutorEdit.getRejection());
            editTextRemarks.setTextColor(-65536);
        }
        editTextRemarks.setText("s"+cardTutorEdit.getArrayListExpertise().size());
    ...
    public void openImage(ImageView imageView, Uri uri) {
        ...
        try {
            if (ActivityCompat.checkSelfPermission(MainActivityRegisterTutor.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MainActivityRegisterTutor.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
            } else {
    ...
    public void setListSpinerArea() {
        ...
        if (flagEdit) areaList.add(cardTutorEdit.getArea());
    ...
    public void retrieveData() {
        ...
        cardRef2.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                cardTutor.setId(registerInformation.getId());
                upladUriFirebase();
    ...
    public void upladUriFirebase() {
        cardTutor.setEmail(email);
        cardTutor.setNumImage(arrayListImageViewUri.size());
        ...
        if (flagEdit && flagImageDeleteConfirmation != 1) {
            ...
            cardTutor.setKey(cardRef5.getKey());
            cardRef5.setValue(cardTutor);
            registerInformation.addCardcar(cardTutor);
            ...
            Toast.makeText(MainActivityRegisterTutor.this, "כרטיס נשמר בהצלחה", Toast.LENGTH_SHORT).show();
        ...
        riversRef.putFile(arrayListImageViewUri.get(num - 1))
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                url = uri.toString();
                                cardTutor.addImageViewArrayListName(url);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        Toast.makeText(MainActivityRegisterTutor.this, "תמונה לא נשמרה", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void fireBase() {
        ...
        cardTutor.setKey(keyCard);
        registerInformation.addCardcar(cardTutor);
        cardRef4.setValue(cardTutor);
    ...
    private void setCard() {
        ...
        cardTutorEdit.setKey(bundle.getString("key"));
        cardTutorEdit.setEmail(bundle.getString("email"));
        cardTutorEdit.setArea(bundle.getString("area"));
        cardTutorEdit.setNumImage(bundle.getInt("numImage"));
        cardTutorEdit.setCity(bundle.getString("city"));
        cardTutorEdit.setPhone(bundle.getString("phone"));

        cardTutorEdit.setRemarks(bundle.getString("remarks"));
        cardTutorEdit.setPriceToLesson(bundle.getString("priceDay"));
        cardTutorEdit.setNumExpertise(bundle.getInt("numExpertise"));

        cardTutorEdit.setName(bundle.getString("name"));
        cardTutorEdit.setId(bundle.getInt("id"));
        cardTutorEdit.setPermissionToPublish(bundle.getInt("permissionToPublish"));
        cardTutorEdit.setRejection(bundle.getString("rejection"));
        for (int i = 0; i < cardTutorEdit.getNumExpertise(); i++)
            cardTutorEdit.addExpertise(bundle.getString("expertise" + i));
        for (int i = 1; i <= cardTutorEdit.getNumImage(); i++)
            cardTutorEdit.addImageViewArrayListName(bundle.getString("image" + i));
...
//                    if (cardTutorEdit.getId() == registerInformation.getCardsUser().get(i).getId()) {
//                        registerInformation.removeCardCar(i);
//                        // Toast.makeText(MainActivityRegisterTutor.this, key, Toast.LENGTH_SHORT).show();
//                        break;
//                    }
//                }
//
//                mDatabase.child(key).setValue(registerInformation);
        if (cardTutorEdit.getPermissionToPublish() == 0) {
            DatabaseReference ref2 = FirebaseDatabase.getInstance().getReference("CardsWaitApprov");
            ref2.child(cardTutorEdit.getKey()).removeValue();
        } else if (cardTutorEdit.getPermissionToPublish() == 1) {
            DatabaseReference ref2 = FirebaseDatabase.getInstance().getReference("CardsApprov");
            ref2.child(cardTutorEdit.getKey()).removeValue();
        } else if (cardTutorEdit.getPermissionToPublish() == 2) {
...
//        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.myPageMenu:
                intent2 = new Intent(MainActivityRegisterTutor.this, MainActivityPageUser.class);
                startActivity(intent2);
                return true;
            case R.id.cardCarMenu:
                intent2 = new Intent(MainActivityRegisterTutor.this, MainActivityRegisterTutor.class);
                startActivity(intent2);
                return true;
            default:
    ...
    private void dialogeImageDeleteConfirmation() {
        ...
        buttonYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                cardTutor.setImageViewArrayListName(new ArrayList<String>());
                d.dismiss();
            }
        });
    ...
    private void dialogExpertise() {
        final Dialog d = new Dialog(this);
        d.setContentView(R.layout.activity_main_add_expertise);
        d.setTitle("Image delete confirmation");
        final ArrayList<String> arrayListExpertise = new ArrayList<>();

        d.setCancelable(true);
        Button buttonAdd = (Button) d.findViewById(R.id.buttonAddInEpertise);
        final Button buttonEnd = (Button) d.findViewById(R.id.buttonEndAdd);
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText editText = (EditText) d.findViewById(R.id.editTextExpertise);
                arrayListExpertise.add(editText.getText().toString());
                ListView lv1 = (ListView) d.findViewById(R.id.listViewAddIneEpertise);
                ExpertiseAdapter expertiseAdapter = new ExpertiseAdapter(MainActivityRegisterTutor.this, 0, 0, arrayListExpertise);
            lv1.setAdapter(expertiseAdapter);
                lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        buttonEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (arrayListExpertise.size() > 0) {
                    cardTutor.setArrayListExpertise(arrayListExpertise);
                    ListView lv1 = findViewById(R.id.listViewMainAddexp);
                    ExpertiseAdapter expertiseAdapter = new ExpertiseAdapter(MainActivityRegisterTutor.this, 0, 0, cardTutor.getArrayListExpertise());
                    lv1.setAdapter(expertiseAdapter);
                    lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    EditText editText = (EditText) d.findViewById(R.id.editTextExpertise);
                    editText.setError("אנא הכנס מקצוע או קורס");
