...
public class MainActivityPageUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityPageUser.this, MainActivityRegisterTutor.class);
        ...
        pageMainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityPageUser.this, MainActivity1.class);
                startActivity(intent);
            }
        });
        ...
        cardRef2.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (type.equals("CardsRejection") && arrayListCards.size() > 0) {
                    cardCarAdapter = new CardCarAdapter(MainActivityPageUser.this, 0, 0, arrayListCards,true,0);
                    ...
                    lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            MainActivity1.pass(intent, arrayListCards.get(i));
                            startActivityForResult(intent, 0);
                        }
                    });
                }  if (type.equals("CardsRejection") && arrayListCards.size() == 0) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.mainMenu:
                intent2 = new Intent(MainActivityPageUser.this, MainActivity1.class);
            ...
            case R.id.cardCarMenu:
                intent2 = new Intent(MainActivityPageUser.this, MainActivityRegisterTutor.class);
                startActivity(intent2);
                return true;
